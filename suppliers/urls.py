...
urlpatterns = [
    ...
    path('api/v1/suppliers/', views.SupplierListCreateAPIView.as_view(), name='supplier_list_create_api'),
    path('api/v1/suppliers/<int:pk>/', views.SupplierDetailAPIView.as_view(), name='supplier_detail_api'),
]
