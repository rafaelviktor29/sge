...
urlpatterns = [
    ...
    path('api/v1/brands/', views.BrandListCreateAPIView.as_view(), name='brand_list_create_api'),
    path('api/v1/brands/<int:pk>/', views.BrandDetailAPIView.as_view(), name='brand_detail_api'),
]
